...
class LikedViewModel extends AsyncNotifier<PaginatedState<Post>> {
  ...
  Future<void> refresh() async {
    ...
    final result = await _postUseCase.getLikedPosts.invoke(
      offset: 0,
      limit: _limit,
    );
...
// import 'package:imagix/domain/post/use_case/post_use_case.dart';
//
// class LikedViewModel extends AsyncNotifier<List<Post>> {
//   PostUseCase get _postUseCase =>
//       ref.read(DependencyModule.postUseCaseProvider);
//
//   static const int _limit = 20;
...
//
//   Future<void> refresh() async {
//     state = await AsyncValue.guard(() => _fetchLikedPosts());
//   }
// }
